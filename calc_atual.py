...
Pantalla.grid(row = 0, column = 0, columnspan = 4, padx = 20, pady = 20, sticky='nsew') #padx e pady coloca espaço pra que nao fique como no comentário anterior
#botoes
color_boton = 'bisque'
ancho_boton = 5
alto_boton = 1
...
BotonExp = Button(ventana, text = 'exp', font= fonte, bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                  command=lambda:click('exp')).grid(row = 1, column = 0, padx = 10,pady = 10, sticky="nsew")
BotonParIz = Button(ventana, text = '(', font= fonte,bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                    command=lambda:click('(')).grid(row = 1, column = 1,padx = 10, pady = 10, sticky="nsew")
BotonParDer = Button(ventana, text = ')', font= fonte, bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                     command=lambda:click(')')).grid(row = 1, column = 2,padx = 10, pady = 10, sticky="nsew")
BotonClear = Button(ventana, text = 'C', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                    command=lambda:clear()).grid(row = 1, column = 3, padx = 10, pady = 10, sticky="nsew")

#botones de la segunda fila
BotonRaiz = Button(ventana, text = '√', font= fonte, bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                   command=raiz_quadrada).grid(row = 2, column = 0, padx = 10,pady = 10, sticky="nsew")
BotonMod = Button(ventana, text = '%', font= fonte, bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                  command = lambda:porcentagem()).grid(row = 2, column = 1, padx = 10,pady = 10, sticky="nsew")
BotonLog = Button(ventana, text = 'log', font=('arial',10,'bold'), bg=color_boton, width=ancho_boton, height=alto_boton, bd=5, relief=relief,
                  command=lambda:click('log(')).grid(row = 2, column = 2, padx=10, pady=10, sticky="nsew")
BotonFact = Button(ventana, text = '!', font=fonte, bg=color_boton, width=ancho_boton, height=alto_boton, bd=5, relief=relief,
                   command=lambda:click('factorial(')).grid(row = 2, column = 3, padx=10, pady=10, sticky="nsew")

#botones de la tercera fila
Boton7 = Button(ventana, text = '7', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(7)).grid(row = 3, column = 0,padx = 10, pady = 10, sticky="nsew")
Boton8 = Button(ventana, text = '8', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(8)).grid(row = 3, column = 1,padx = 10, pady = 10, sticky="nsew")
Boton9 = Button(ventana, text = '9', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(9)).grid(row = 3, column = 2, padx = 10,pady = 10, sticky="nsew")
BotonDiv = Button(ventana, text = '÷', font= fonte, bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                  command=lambda:click('/')).grid(row = 3, column = 3,padx = 10, pady = 10, sticky="nsew")

#botones de la quarta fila
Boton4 = Button(ventana, text = '4', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(4)).grid(row = 4, column = 0, padx = 10,pady = 10, sticky="nsew")
Boton5 = Button(ventana, text = '5', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(5)).grid(row = 4, column = 1,padx = 10, pady = 10, sticky="nsew")
Boton6 = Button(ventana, text = '6', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(6)).grid(row = 4, column = 2, padx = 10,pady = 10, sticky="nsew")
BotonMult = Button(ventana, text = 'x', font= fonte, bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                   command=lambda:click('*')).grid(row = 4, column = 3, padx = 10,pady = 10, sticky="nsew")


#botones de la quinta fila
Boton1 = Button(ventana, text = '1', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(1)).grid(row = 5, column = 0, padx = 10,pady = 10, sticky="nsew")
Boton2 = Button(ventana, text = '2', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(2)).grid(row = 5, column = 1, padx = 10,pady = 10, sticky="nsew")
Boton3 = Button(ventana, text = '3', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(3)).grid(row = 5, column = 2, padx = 10,pady = 10, sticky="nsew")
BotonResta = Button(ventana, text = '-', font= fonte, bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                    command=lambda:click('-')).grid(row = 5, column = 3, padx = 10,pady = 10, sticky="nsew")


#botones de la sexta fila
Boton0 = Button(ventana, text = '0', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                command=lambda:click(0)).grid(row = 6, column = 0, padx = 10,pady = 10, sticky="nsew")
Boton00 = Button(ventana, text = '00', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                 command=lambda:click('00')).grid(row = 6, column = 1, padx = 10,pady = 10, sticky="nsew")
BotonPunto = Button(ventana, text = '.', font= fonte, bg = 'salmon1', width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                    command=lambda:click('.')).grid(row = 6, column = 2, padx = 10,pady = 10, sticky="nsew")
BotonSuma = Button(ventana, text = '+', font= fonte, bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
                   command=lambda:click('+')).grid(row = 6, column = 3, padx = 10,pady = 10, sticky="nsew")

#botones de la setima fila
BotonApUl= Button(ventana, text = '⌫', font=fonte, bg = 'salmon1', width=ancho_boton, height=alto_boton, bd=5, relief=relief,
                   command=lambda:apagar_ultimo()).grid(row = 7, column = 0, columnspan=2, padx=10, pady=10, sticky="nsew")
BotonIgual= Button(ventana, text = '=', font= fonte, bg = color_boton, width = ancho_boton, height = alto_boton,bd=5,relief=relief,
