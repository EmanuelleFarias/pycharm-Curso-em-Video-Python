...
BotonClear = Button(ventana, text = 'C', bg = color_boton, width = ancho_boton, height = alto_boton,
                    command=lambda:clear()).grid(row = 1, column = 0, padx = 10, pady = 10, sticky="nsew")
BotonParIz = Button(ventana, text = '(', bg = color_boton, width = ancho_boton, height = alto_boton,
                    command=lambda:click('(')).grid(row = 1, column = 1,padx = 10, pady = 10, sticky="nsew")
BotonParDer = Button(ventana, text = ')', bg = color_boton, width = ancho_boton, height = alto_boton,
                     command=lambda:click(')')).grid(row = 1, column = 2,padx = 10, pady = 10, sticky="nsew")
BotonExp = Button(ventana, text = 'exp', bg = color_boton, width = ancho_boton, height = alto_boton,
                  command=lambda:click('exp')).grid(row = 1, column = 3, padx = 10,pady = 10, sticky="nsew")

#botones de la segunda fila

Boton7 = Button(ventana, text = '7', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(7)).grid(row = 2, column = 0,padx = 10, pady = 10, sticky="nsew")
Boton8 = Button(ventana, text = '8', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(8)).grid(row = 2, column = 1,padx = 10, pady = 10, sticky="nsew")
Boton9 = Button(ventana, text = '9', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(9)).grid(row = 2, column = 2, padx = 10,pady = 10, sticky="nsew")
BotonDiv = Button(ventana, text = '÷', bg = color_boton, width = ancho_boton, height = alto_boton,
                  command=lambda:click('/')).grid(row = 2, column = 3,padx = 10, pady = 10, sticky="nsew")

#botones de la tercera fila
Boton4 = Button(ventana, text = '4', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(4)).grid(row = 3, column = 0, padx = 10,pady = 10, sticky="nsew")
Boton5 = Button(ventana, text = '5', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(5)).grid(row = 3, column = 1,padx = 10, pady = 10, sticky="nsew")
Boton6 = Button(ventana, text = '6', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(6)).grid(row = 3, column = 2, padx = 10,pady = 10, sticky="nsew")
BotonMult = Button(ventana, text = 'x', bg = color_boton, width = ancho_boton, height = alto_boton,
                   command=lambda:click('*')).grid(row = 3, column = 3, padx = 10,pady = 10, sticky="nsew")


#botones de la cuarta fila
Boton1 = Button(ventana, text = '1', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(1)).grid(row = 4, column = 0, padx = 10,pady = 10, sticky="nsew")
Boton2 = Button(ventana, text = '2', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(2)).grid(row = 4, column = 1, padx = 10,pady = 10, sticky="nsew")
Boton3 = Button(ventana, text = '3', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(3)).grid(row = 4, column = 2, padx = 10,pady = 10, sticky="nsew")
BotonResta = Button(ventana, text = '-', bg = color_boton, width = ancho_boton, height = alto_boton,
                    command=lambda:click('-')).grid(row = 4, column = 3, padx = 10,pady = 10, sticky="nsew")


#botones de la quinta fila
Boton0 = Button(ventana, text = '0', bg = color_boton, width = ancho_boton, height = alto_boton,
                command=lambda:click(0)).grid(row = 5, column = 0, padx = 10,pady = 10, sticky="nsew")
Boton00 = Button(ventana, text = '00', bg = color_boton, width = ancho_boton, height = alto_boton,
                 command=lambda:click('00')).grid(row = 5, column = 1, padx = 10,pady = 10, sticky="nsew")
BotonPunto = Button(ventana, text = '.', bg = color_boton, width = ancho_boton, height = alto_boton,
                    command=lambda:click('.')).grid(row = 5, column = 2, padx = 10,pady = 10, sticky="nsew")
BotonSuma = Button(ventana, text = '+', bg = color_boton, width = ancho_boton, height = alto_boton,
                   command=lambda:click('+')).grid(row = 5, column = 3, padx = 10,pady = 10, sticky="nsew")

#botones de la sexta fila
BotonRaiz = Button(ventana, text = '√', bg = color_boton, width = ancho_boton, height = alto_boton,
                   command=raiz_quadrada).grid(row = 6, column = 0, padx = 10,pady = 10, sticky="nsew")
BotonMod = Button(ventana, text = '%', bg = color_boton, width = ancho_boton, height = alto_boton,
                  command = lambda:porcentagem()).grid(row = 6, column = 1, padx = 10,pady = 10, sticky="nsew")
BotonIgual= Button(ventana, text = '=', bg = color_boton, width = ancho_boton, height = alto_boton,
